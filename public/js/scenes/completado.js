class SceneCompletado extends Phaser.Scene {
  constructor() {
    super('completado');
  }
  ...
  create() {
    ...
    this.add.text(pw(50), ph(30), "¡HAS GANADO!")
      .setFontSize(48).setFontFamily('Verdana').setFontStyle('bold').setOrigin(0.5);

    this.add.text(pw(50), ph(50), "¡Enhorabuena! Has conseguido pasarte todos los niveles <3")
